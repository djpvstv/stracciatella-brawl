...
HOOK @ $8077F9D8
{
  ...
  cmplwi r12, 0x10C              # |
  blt+ exit                      # |
  cmplwi r12, 0x10D              # | If we're not currently taunting...
  bgt+ exit                      # / ... skip.

  cmplwi r4, 0x43                # \
  blt+ exit                      # |
  cmplwi r4, 0x4C                # | If target action isn't between 0x45 and 0x4C (ie. we're getting hit)...
  bgt+ exit                      # / ... skip.
  ...
  lfs f12, -0x1B68(r13)          # Load 15.0f in f12...
  fadds f11, f12, f12            # ... and double it into f11 for 30.0f.
  fcmpo cr1, f13, f11            # Compare the current frame against that...
...
parrySuccessful:
  ...
  fcmpo cr1, f13, f12            # Compare current frame against 15.0f...
